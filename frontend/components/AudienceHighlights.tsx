const AUDIENCES = [
  {
    icon: "🏠",
    title: "For Home Learning",
    text: "A shared activity kids and adults can play together at home. Bright, encouraging, and never punishing a wrong guess.",
  },
  {
    icon: "⛪",
  ...
  return (
    <section className="grid gap-8 rounded-[1.75rem] bg-royal-50 p-6 shadow-soft sm:p-8">
      <div className="text-center">
        ...
        <h2 className="mt-2 text-2xl font-black text-slate-900 sm:text-3xl">Built for Homes, Churches &amp; Schools</h2>
